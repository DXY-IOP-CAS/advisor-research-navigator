...
迁移后，项目根目录已经是 `AGENTS.md`、`QUICKSTART.md`、`quality-workbench/`、`.agents/skills/`、`src/`、`tests/` 这一层，不再嵌在旧中文路径下面。
...
- 根入口：`AGENTS.md`、`QUICKSTART.md`
- 项目文档：`docs/`
- 当前设计工作台：`quality-workbench/`
- 项目 skill：`.agents/skills/research-advisor/`
- 阶段 1 脚本和文档：`src/phase1/`
- 测试：`tests/` 和 `.agents/skills/research-advisor/tests/`
- 当前输出样本：`output/`
- 已跟踪的存档目录：`archive/`
...
2. `QUICKSTART.md`
3. `docs/上下文交接.md`
4. 当前任务相关的 `quality-workbench/`、`.agents/skills/research-advisor/` 或 `src/phase1/pipeline.md`
