...
| §2 学术履历 | — | AI 从官网/广域搜写入 |
| §3 研究方向 | — | AI 从官网文本写入 |
| §4 论文列表 | **论文表格**（标题超链接） | 每阶段叙事段落。**不要重写表格行** |
...
**⚠️ 硬约束：AI 润色时禁止重写 §4 论文表格。** 脚本生成的论文表格（含标题超链接、来源标记、引用数）是准确数据，AI 润色时**只能**在表格前补充叙事段落，**不能**修改表格行内容或格式。如果发现表格需要修正，应修改 render_profile.py 而非手动改 markdown。
